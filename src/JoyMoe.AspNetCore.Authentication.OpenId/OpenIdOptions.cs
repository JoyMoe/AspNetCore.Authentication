...
{
    public class OpenIdOptions : RemoteAuthenticationOptions
    {
        ...
        {
            AuthenticationScheme = OpenIdDefaults.AuthenticationScheme;
            DisplayName = OpenIdDefaults.DisplayName;
            CallbackPath = new PathString(OpenIdDefaults.CallbackPath);
        ...
        /// </summary>
        public IConfigurationManager<OpenIdConfiguration> ConfigurationManager { get; set; }
        ...
        /// </summary>
        public new OpenIdEvents Events
        {
            get { return base.Events as OpenIdEvents; }
        ...
        /// </summary>
        public new IDataProtectionProvider DataProtectionProvider { get; set; }
